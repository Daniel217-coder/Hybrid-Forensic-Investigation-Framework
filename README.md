...
| Item | Path | Notes |
|------|------|-------|
| Sample test APK | `cases/CASE_001/evidence/com.neumorphic.calculator_2.apk` | Calculator F-Droid (benign app for calibration) |
...
2. Click **Browse APK** and select your `.apk` file.
   ...
   > (This is Calculator for Android from F-Droid — a known benign app, useful for calibration.)
